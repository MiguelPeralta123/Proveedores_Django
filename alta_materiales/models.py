...
class Material(models.Model):
    ...
    largo = models.CharField(max_length=20, default='N/A')
    ancho = models.CharField(max_length=20, default='N/A')
    alto = models.CharField(max_length=20, default='N/A')
    calibre = models.CharField(max_length=20, default='N/A')
