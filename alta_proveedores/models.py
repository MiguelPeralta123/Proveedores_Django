...
class Proveedor(models.Model):
    ...
    rubro = models.CharField(max_length=20, blank=True)
    tipo_operacion = models.CharField(max_length=10, blank=True)
    tipo_tercero = models.CharField(max_length=20, blank=True)
    id_fiscal = models.CharField(max_length=10, blank=True)
    agente_aduanal = models.CharField(max_length=10, blank=True)
    dias_credito = models.PositiveIntegerField(default=0, blank=True)
    limite_credito_MN = models.PositiveIntegerField(default=0, blank=True)
    limite_credito_ME = models.PositiveIntegerField(default=0, blank=True)
    monto_credito = models.PositiveIntegerField(default=0, blank=True)
