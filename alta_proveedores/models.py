...
class Proveedor(models.Model):
    ...
    constancia_situacion_fiscal = models.FileField(upload_to='static/proveedores/constancias', blank=True)
    estado_cuenta_bancario = models.FileField(upload_to='static/proveedores/estados_cuenta', blank=True)
